...
import br.com.siberius.jreport.types.JReportColumn;
...
public class JReportTemplate {
    ...
    public String genDefaultGpdfTemplate() {
        ...
        String gpdfTemplate = "\n" +
                ...
                "drb.addFirstPageImageBanner(new ClassPathResource(\"BOOT-INF/small-logo.png\").getPath(), new Integer(90), new Integer(40), ImageBanner.ALIGN_CENTER, ImageScaleMode.REAL_SIZE  );\n" +
